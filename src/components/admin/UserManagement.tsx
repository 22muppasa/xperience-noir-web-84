  ...
  const updateApprovalStatusMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        ...
        description: `Administrator has been ${data.status}`,
      });
    ...
    return (
      <div className="max-w-xl mx-auto mt-16">
        <Card className="bg-red-50 border-red-300">
          <CardHeader>
            <CardTitle className="text-red-900">Error loading administrators</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-red-700 mb-2">
              We couldn't retrieve administrator data from the database at this time.
            </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-black">Administrator Management</h2>
          <p className="text-black">
            Manage all administrators and their permissions 
            {pendingCount > 0 && (
      ...
      <Card className="bg-white border-black">
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-black">Administrators ({filteredUsers?.length || 0})</CardTitle>
            <div className="flex items-center space-x-2">
              <Checkbox
        ...
        <AlertDialogContent className="bg-white border-black">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-black">
              Are you sure you want to {approvalDialog.newStatus} {approvalDialog.user?.first_name} {approvalDialog.user?.last_name}'s administrator account?
              {approvalDialog.newStatus === 'approved' && ' This will grant them full admin access.'}
