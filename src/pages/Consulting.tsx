...
const Consulting = () => {
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-900">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-medium mb-6 animate-fade-in text-white drop-shadow-lg">
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-fade-in animate-delay-300 border border-gray-700">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-fade-in animate-delay-500 border border-gray-700">
                    <div className="flex items-center gap-3 mb-2">
                ...
                <div className="space-y-4 mt-8">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-fade-in animate-delay-400 border border-gray-700">
                    <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-fade-in animate-delay-600 border border-gray-700">
                    <div className="flex items-center gap-3 mb-2">
      ...
      <section id="portfolio" className="py-20 px-4 md:px-6 bg-white text-gray-900">
              ...
              {pastProjects.map((project) => (
                <CarouselItem key={project.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                  <Dialog>
                    <DialogTrigger asChild>
                      <div className="group cursor-pointer bg-white border rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div className="p-6">
                          ...
                          <h3 className="text-xl font-medium mb-3 text-gray-900 group-hover:text-blue-700 transition-colors">{project.name}</h3>
                    ...
                    <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto bg-white border border-gray-200 shadow-2xl text-gray-900">
                      ...
                      <div className="space-y-8">
                        <div className="aspect-[16/9] overflow-hidden rounded-xl border border-gray-200 bg-gray-200">
                          <img 
                            src={project.image} 
                            alt={project.name}
      ...
      {/* Services */}
      <section className="py-20 px-4 md:px-6 bg-gray-50 text-gray-900">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
