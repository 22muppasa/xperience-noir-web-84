  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-medium mb-12 text-center">Ways to Get Involved</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border rounded-lg overflow-hidden hover-scale">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium mb-4">Volunteer</h3>
                ...
                <a href="#volunteer-form" className="inline-flex items-center font-medium button-hover">
                  Apply to Volunteer
                </a>
              </div>
            </div>
            ...
            <div className="bg-white border rounded-lg overflow-hidden hover-scale">
              ...
              <div className="p-6">
                ...
                <a href="#donate-section" className="inline-flex items-center font-medium button-hover">
                  Make a Donation
                </a>
              </div>
            </div>
            ...
            <div className="bg-white border rounded-lg overflow-hidden hover-scale">
              ...
              <div className="p-6">
                ...
                <Link to="/contact" className="inline-flex items-center font-medium button-hover">
                  Contact Our Team
                </Link>
              </div>
            </div>
      ...
      <section id="volunteer-form" className="py-20 px-4 md:px-6 bg-gray-50">
        <div className="container mx-auto max-w-3xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-medium mb-6">Volunteer Application</h2>
      ...
      {/* Donate Section */}
      <section id="donate-section" className="py-20 px-4 md:px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-medium mb-6">Support Our Mission</h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium mb-1">Fund a Scholarship</h3>
                    <p className="text-gray-600">Provide financial support for students from underrepresented backgrounds.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium mb-1">Support New Programs</h3>
                    <p className="text-gray-600">Help us develop and launch new educational initiatives.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Fund initiatives that bring technology education to underserved communities.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              <h3 className="text-xl font-medium mb-6">Choose Your Donation</h3>
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                <div className="bg-white border rounded-md py-3 px-4 text-center cursor-pointer hover:border-black transition-colors">
                  $25
                </div>
                <div className="bg-white border rounded-md py-3 px-4 text-center cursor-pointer hover:border-black transition-colors">
                  $50
      ...
      <section className="py-20 px-4 md:px-6 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-medium mb-6">Our Corporate Partners</h2>
