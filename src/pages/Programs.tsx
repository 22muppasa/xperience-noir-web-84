          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
            ...
            {user && (
              <Button variant="outline" asChild>
                <Link to="/admin/programs" className="flex items-center gap-2">
                  Manage Programs
                  <ArrowRight size={16} />
                </Link>
              </Button>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-soft">
              <h3 className="text-xl font-medium mb-2 text-black">What types of programs do you offer?</h3>
              <p className="text-gray-600">
                We offer a variety of educational programs designed to foster creativity, learning, and personal growth in children of all ages.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-soft">
              ...
              <p className="text-gray-600">
                Contact us directly for detailed information about any program that interests you. We're happy to provide more details and answer any questions.
              </p>
            </div>
